...
function default_1(path) {
    return __awaiter(this, void 0, void 0, function () {
        var urlPattern, data, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    urlPattern = new RegExp('https?://(www.)?[-a-zA-Z0-9@:%._+~#=]{1,256}', 'i');
                    if (!urlPattern.test(path)) return [3 /*break*/, 2];
                ...
                case 2: return [2 /*return*/, fs_1.default.readFileSync(path)];
                case 3:
                    error_1 = _a.sent();
